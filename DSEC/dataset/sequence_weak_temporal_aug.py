...
class Sequence(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.require_paired_data:
            ...
            if self.mode == 'train':
                return output['representation']['left'], output['img_left'], label_tensor, short_event_tensor, dense_label_tensor, str(img_left_path)
            else:
                return output['representation']['left'], output['img_left'], label_tensor, short_event_tensor, str(img_left_path)

        if self.mode == 'train':
            return output['representation']['left'], label_tensor, short_event_tensor, dense_label_tensor, str(img_left_path)
        else:
            return output['representation']['left'], label_tensor, short_event_tensor, str(img_left_path)
