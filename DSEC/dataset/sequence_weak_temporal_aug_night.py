...
class Sequence(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for location in self.locations:
            ...
            reverse_path = voxel_path.replace(self.voxel_name, self.reverse_voxel_name)
        ...
        if self.require_paired_data:
            ...
            if self.mode == 'train':
                return output['representation']['left'], output['img_left'], label_tensor, short_event_tensor, label_tensor
            else:
