...
if __name__=='__main__':
    ...
    # dataset_dir = './DSEC_Night_labels_warp_images_V1'
    ...
    class Sequence():
        def __init__(self, seq_path: Path, event_representation: str = 'voxel_grid'):
            ...
            # nr_events_per_data: int = 100000 #-> original
            nr_events_per_data: int = 2000
            ...
            del self.img_left_pathstrings[:1]
            ...
            for location in self.locations:
                ...
                ev_voxel_dir = ev_dir_location / 'voxel_2000'
                ev_reverse_voxel_dir = ev_dir_location / 'reverse_voxel_5_2000'
        ...
        def getitem(self, index):
            img_path = Path(self.img_left_pathstrings[index])
            ...
            for location in self.locations:
                ...
                event_save_path = self.ev_voxel_dir[location] / str(img_path).split('/')[-1].replace('png', 'npy')
                
                reverse_event_save_path = self.ev_reverse_voxel_dir[location] / str(img_path).split('/')[-1].replace('png', 'npy')
